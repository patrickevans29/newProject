...
unloadServer()
{
    launchctl unload -S Aqua $HOME/Library/LaunchAgents/com.cisco.videoguard10.plist
    if [ "$1" != "auto" ]
    then
        launchctl unload -S Aqua $HOME/Library/LaunchAgents/com.cisco.videoguard10.uninstall.plist
    fi
}
...
removeServer()
{
	rm -rf $HOME/Library/LaunchAgents/com.cisco.videoguard10.plist > /dev/null 2>&1
	rm -rf $HOME/Library/LaunchAgents/com.cisco.videoguard10.uninstall.plist > /dev/null 2>&1

	rm -rf $HOME/Library/Cisco/VideoGuardPlayer/VideoGuard10
